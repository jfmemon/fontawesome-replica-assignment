...
const SubHeaderCategory = ({ items }) => {
    ...
    return (
        <div className='cursor-pointer flex flex-col justify-center items-center text-slate-700 hover:text-teal-500 focus:text-sky-600' onClick={handleLoadIcons} tabIndex={0} >
            <div className='p-4'>
                {
