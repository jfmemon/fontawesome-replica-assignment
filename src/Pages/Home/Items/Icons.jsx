...
const Icons = ({ item }) => {
    ...
    return (
        <div className='bg-white text-slate-700 rounded-lg md:w-32 md:h-32 w-40 h-40 cursor-pointer flex flex-col gap-5 justify-center items-start hover:bg-[#ffd43b]'>
